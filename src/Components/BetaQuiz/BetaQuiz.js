      ...
      <ScrollAnimation animateIn="fadeIn" duration={0.6} animateOnce>
        <div className="beta-quiz-section">
          ...
          <ol>
            <li>Take our quiz</li>
            <li>
              Our concierge will send you a curated list of Bonny approved
              products.
            </li>
            <li>
              Receive unique links for each recommended product so that you can
              buy them straight from the source.
            </li>
          </ol>
          <Button
            id="beta-button"
